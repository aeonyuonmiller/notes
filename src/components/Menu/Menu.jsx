...
const Menu = ({ closeModal, logoutBtn }) => {
    ...
    return (
        ...
        <motion.div className="backdrop" key="backdropp" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            <motion.div className="wrapperMenu" initial={{ scale: 0.95, opacity: 0, x: 300, rotate: 8 }} animate={{ scale: 1, opacity: 1, x: 0, rotate: 0 }} exit={{ opacity: 0, x: -100 }} transition={{ type: "spring", stiffness: 700, damping: 70 }}>
